...
enum snd_pcm_chmap_position {
	...
	SND_CHMAP_BB_LAST = SND_CHMAP_BB_SRL
};
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/asound/public/include/sys/asound.h $ $Rev: 732568 $" )
#endif
