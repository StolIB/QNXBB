...
#define HWI_TAG_NAME_compatible		"compatible"
#define HWI_TAG_ALIGN_compatible	(sizeof(_Uint32t))
struct hwi_compatible {
	struct hwi_prefix	prefix;
	_Uint32t			string;
};
...
typedef union {
	...
	struct hwi_compatible 		compatible;
	struct hwi_dma		 		dma;
	struct hwi_irq		 		irq;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/services/system/public/hw/sysinfo.h $ $Rev: 780433 $")
#endif
