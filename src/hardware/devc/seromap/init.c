...
ser_attach_intr(DEV_OMAP *dev)
{
	...
	// According to the National errata sheet you must wait for the transmit
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/devc/seromap/init.c $ $Rev: 774102 $")
#endif
