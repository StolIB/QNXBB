...
#define CPTS_RFTCLK_SEL				0x00000c08
	#define GMAC_CLKCTRL				CPTS_RFTCLK_SEL
	#define GMAC_CLKCTRL_RFT_MASK			0x0000001f
	#define GMAC_CLKCTRL_RFT_SHIFT			0
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/lib/io-pkt/sys/dev_qnx/dm814x/arm/am335x.dll.le.v7/ti814x.h $ $Rev: 796042 $")
#endif
