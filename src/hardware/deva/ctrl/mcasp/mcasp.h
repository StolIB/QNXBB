...
#define AFSRCTL_RMOD_16CH       (16<<7)     /* 16-slot TDM */
...
#define WFIFOCTL_WC             (64)        /* Maximum FIFO word counts */
...
#define RFIFOCTL_WC             (64)        /* Maximum FIFO word counts */
...
typedef struct mcasp_play_strm {
    ...
    uint8_t            fsync_pol;
    uint8_t            clk_pol;
#define NUMBER_OF_SERIALIZER 16
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/deva/ctrl/mcasp/mcasp.h $ $Rev: 791421 $")
#endif
