...
#define ATMEL_HSMCI_DMAC_SIZE          (0x200)

// TODO: DMA structures

typedef struct {
    /* Virtual base address of HSMCI registers */
    uintptr_t base;
} atmel_hc_hsmci_t;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/devb/sdmmc/sdiodi/hc/atmel-hsmci.h $ $Rev: 789718 $")
#endif
