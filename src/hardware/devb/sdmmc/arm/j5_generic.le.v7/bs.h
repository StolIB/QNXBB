...
#define SDIO_HWI_NAME			"MMCHS"

#define BS_EVENT

typedef struct _omap_ext {
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/devb/sdmmc/arm/j5_generic.le.v7/bs.h $ $Rev: 733968 $")
#endif
