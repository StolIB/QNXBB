...
#define RXCSR_P_WZC_BITS	(RXCSR_SENT_STALL | RXCSR_OVERRUN | RXCSR_RXPKTRDY)
...
#define EP_FLAG_XFER_INPROGRESS					( 1 << 4 )

#define TD_STS_TOKEN_SETUP			0x01
#define TD_STS_TOKEN_STATUS		0x02
#define TD_STS_TOKEN_IN	 			0x04
#define TD_STS_TOKEN_OUT			0x08

// The following bit are the same as PIPE_FLAGS_* in io-usb.h
#define TD_STS_FLAGS_MULTI_XFER	0x20
#define TD_STS_LAST_PACKET			0x80000000

//device specific defines
#define TD_STS_SCHEDULED			0x0100
#define TD_STS_USE_DMA0			0x0200
#define TD_STS_USE_DMA1			0x0400
#define TD_STS_USE_DMA				( TD_STS_USE_DMA0 | TD_STS_USE_DMA1 )
#define TD_STS_RNDIS_DMA			0x0800
#define TD_STS_ABORT_DMA			0x1000
#define TD_STS_USE_EDMA			0x2000
#define TD_STS_ZLP					0x4000	//it has a zlp packet ending
#define TD_STS_COMP_MSK			0x00FF0000
#define TD_STS_COMPL_POLL			0x00800000
...
#define DC_FLAG_MURB  			( 1 << 10 )
#define DC_FLAG_TX_RNDIS		( 1 << 11 )
#define DC_FLAG_RX_RNDIS		( 1 << 12 )
#define DC_FLAG_CPPI_DMA		( 1 << 13 )
...
struct _dctrl_t {
	...
	int						edma_channel;
	int						edma_irq;
	void 				(*musb_completion_poll)( dctrl_t *dc, musb_transfer_t *td);
};
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/6.6.0/trunk/hardware/devu/dc/musbmhdrc/musb.h $ $Rev: 776862 $")
#endif
